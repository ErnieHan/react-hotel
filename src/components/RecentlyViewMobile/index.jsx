      ...
      <Content>
        ...
        <Body>
          <div className="swiper-layout">
            <div className="swiper-container swiper-container-recently-view-mobile">
              <div className="swiper-wrapper">
                <div className="swiper-slide">
                  <div className="recent-product-content">
                    ...
                    <div className="recent-product-desc">
                      ...
                      <div className="product-name">18K Gold Chrysoprase Bracelet</div>
                ...
                <div className="swiper-slide">
                  <div className="recent-product-content">
                    ...
                    <div className="recent-product-desc">
                      ...
                      <div className="product-name">18K Yellow & White Diamond Bracelet</div>
                ...
                <div className="swiper-slide">
                  <div className="recent-product-content">
                    ...
                    <div className="recent-product-desc">
                      <div className="collection-name">BLOOM</div>
                      <div className="product-name">18K Yellow Gold Freshwater Pearl Earrings</div>
                      <div className="price">HK$5200.00</div>
                    </div>
                  </div>
                </div>
                <div className="swiper-slide">
                  <div className="recent-product-content">
                    ...
                    <div className="recent-product-desc">
                      <div className="collection-name">Symphony</div>
                      <div className="product-name">Lapis Lazuli Double-sided </div>
                      <div className="price">HK$13000.00</div>
                    </div>
                  </div>
                </div>
